        ...
        function specForwards(realtime: boolean): void {
            ...
            describe("lift", () => {
                ...
                it("should support lift", () => {
                    ...
                    const lifted = InfiniteListObservable.create(sequenceRef, notifier, selectKeyedValue, selectKey, {
                        pageSize: 3,
                        realtime
                    }).map(Boolean);
            ...
            describe("forwards", () => {
                ...
                it("should default to orderByKey", () => {
                    ...
                    let notifier = new Subject();
                    let result = InfiniteListObservable.create(sequenceRef, notifier, selectKeyedValue, selectKey, {
                        pageSize: 3,
                        realtime
                    })
                    .take(3)
        ...
        describe("realtime: true", () => {
            ...
            describe("forwards", () => {
                ...
                it("should support adds", (_callback: Function) => {
                    ...
                    let notifier = new Subject();
                    InfiniteListObservable.create(sequenceRef, notifier, selectKeyedValue, selectKey, {
                        pageSize: 3,
                        realtime: true
                    })
                    .map((list, index) => {
